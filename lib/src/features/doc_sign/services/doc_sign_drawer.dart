...
class DocSignDrawer extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size) {
    print(DocSignWidgetsHandler.currentSketches);
    path = Path();
    for (var currentSketch in DocSignWidgetsHandler.currentSketches) 
    {
    final currentDrawing = currentSketch.currentDrawing;
